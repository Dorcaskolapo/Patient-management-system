                        ...
                        <div class="card-header fix-card">
                            <div class="row">
                                ...
                                {{-- <div class="col-4 float-end">
                                    <a href="{{ url('/staff/patient') }}" class="btn btn-primary float-end">New
                                        Patient</a>
                                </div> --}}
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach($patients as $patient)
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    {{-- <a href="{{ url('/staff/viewPatient/'.$patient->slug) }}" class='mr-4 vue'>
                                                                        ...
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="basic-form">
                                                                                    <form method="POST" action="{{ url('/staff/editPatient') }}" enctype="multipart/form-data">
                                                                                        @csrf
                                            ...
                                            <div class="modal fade" id="modal-delete" tabindex="-1" aria-labelledby="modal-title-delete-row" aria-hidden="true">
                                                <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ url('/staff/deletePatient') }}" method="POST">
                                                            @csrf
                                                            <div class="modal-body">
